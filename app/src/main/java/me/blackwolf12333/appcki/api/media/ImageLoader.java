...
public class ImageLoader {
    ...
    public ImageContainer get(Integer id, String type, final ImageListener listener, Map<String, String> headers) {
        String url = String.format(ImageRequest.URL, id, type);
        return get(url, listener, 0, 0, headers);
    }
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
                              int maxWidth, int maxHeight, Map<String, String> headers) {
        return get(requestUrl, imageListener, maxWidth, maxHeight, ScaleType.CENTER_INSIDE, headers);
    }
    /**
